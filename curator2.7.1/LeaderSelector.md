...
public class LeaderSelector implements Closeable
{
    ...
    private final CuratorFramework client;//和zk连接的client
    private final LeaderSelectorListener listener;//自实现leader选择监听器
    private final CloseableExecutorService executorService;
    private final InterProcessMutex mutex;//底层互斥体竞争leader
    ...
    public LeaderSelector(CuratorFramework client, String leaderPath, CloseableExecutorService executorService, LeaderSelectorListener listener)
    {
        ...
        this.client = client;
        this.listener = new WrappedListener(this, listener);        //listener包装内部类
        hasLeadership = false;// 初始没有leader权限
    ...
    public void start()
    {
        ...
        client.getConnectionStateListenable().addListener(listener);//监听Connection状态变化
        requeue();
    }
